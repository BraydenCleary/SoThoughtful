...
class RecipientsControllerTest < ActionController::TestCase
  ...
  test "should create recipient" do
    assert_difference('Recipient.count') do
      post :create, recipient: { email: @recipient.email, first_name: @recipient.first_name, last_name: @recipient.last_name, phone: @recipient.phone }
    end
  ...
  test "should update recipient" do
    put :update, id: @recipient, recipient: { email: @recipient.email, first_name: @recipient.first_name, last_name: @recipient.last_name, phone: @recipient.phone }
    assert_redirected_to recipient_path(assigns(:recipient))
  end
